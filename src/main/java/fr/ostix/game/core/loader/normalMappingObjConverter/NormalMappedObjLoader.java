...
public class NormalMappedObjLoader {
    ...
    public static MeshModel loadOBJ(String objFileName, Loader loader) {
        InputStreamReader isr = new InputStreamReader(OBJFileLoader.class.getResourceAsStream("/obj/" + objFileName + ".obj"));
